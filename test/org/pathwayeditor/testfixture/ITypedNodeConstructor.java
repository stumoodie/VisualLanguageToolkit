...
public interface ITypedNodeConstructor {
	...
	ILinkEdgeFactory createLinkEdgeFactory(ISubModel subModel);
	...
	boolean buildShapeNodeFactory(IShapeNodeFactory nodeFactory);
	
	boolean buildLinkFactory(ILinkEdgeFactory edgeFactory);
}
