...
alter table CanvasAttributeProperty drop constraint Relationship74;
...
alter table LinkTerminus drop constraint FKLinkTermin403161;
alter table LinkEdge drop constraint Relationship120;
alter table LinkEdge drop constraint Relationship121;
alter table CanvasPropertyAttribute drop constraint Relationship147;
alter table LinkAttribute drop constraint Relationship140;
alter table ShapeAttribute drop constraint Relationship141;
alter table CanvasAttributeProperty drop constraint Relationship146;
...
alter table ChildCompoundGraph drop constraint FKChildCompo443436;
...
drop table CanvasAttributeProperty if exists;
...
drop table CanvasPropertyAttribute if exists;
