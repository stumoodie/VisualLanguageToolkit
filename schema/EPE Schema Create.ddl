...
create table LinkTerminus (id integer generated by default as identity (start with 1), link_term_type smallint not null, offset_val smallint not null, link_attribute_id integer not null, end_dec_type integer not null, end_dec_width integer not null, end_dec_height integer not null, term_dec_type integer not null, term_dec_red integer not null, term_dec_green integer not null, term_dec_blue integer not null, term_dec_height integer not null, term_dec_width integer not null, constraint pk_LinkTerminus primary key (id), constraint xak1LinkTerminus unique (link_term_type));
...
alter table LinkTerminus add constraint Relationship144 foreign key (link_attribute_id) references LinkAttribute;
