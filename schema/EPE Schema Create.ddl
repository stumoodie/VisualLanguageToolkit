...
create table BendPoint (id integer generated by default as identity (start with 1), link_attribute_id integer, index_pos integer not null, x_position integer not null, y_position integer not null, constraint pk_BendPoint primary key (id), constraint Alter_Key37 unique (index_pos));
...
create table LinkAttribute (id integer generated by default as identity (start with 1), canvas_id integer not null, creation_serial integer not null, object_type_id integer not null, name varchar(128) not null, detailed_description longvarchar not null, description varchar(2048) not null, line_red integer not null, line_green integer not null, line_blue integer not null, line_style integer not null, line_width integer not null, router_type smallint not null, url varchar(2048) not null, constraint pk_Link primary key (id), constraint xak1LinkAttribute unique (canvas_id, creation_serial));
...
create table Canvas (id integer generated by default as identity (start with 1), repository_id integer not null, map_inode integer not null, context_id integer not null, grid_x integer not null, grid_y integer not null, grid_enabled bit not null, snap_to_grid_enabled bit not null, background_red integer not null, background_green integer not null, background_blue integer not null, canvas_width integer not null, canvas_height integer not null, created date not null, last_modified date not null, constraint pk_Canvas primary key (id), constraint xak1canvas unique (repository_id, map_inode));
...
alter table LinkTerminus add constraint Relationship144 foreign key (LinkAttributeid) references LinkAttribute;
...
alter table LinkAttribute add constraint FKLinkAttrib991945 foreign key (canvas_id) references Canvas;
...
alter table Canvas add constraint Relationship7 foreign key (repository_id) references Repository;
