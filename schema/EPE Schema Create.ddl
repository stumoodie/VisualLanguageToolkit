...
create table LabelAttribute (id integer not null, background_red integer not null, background_green integer not null, background_blue integer not null, y_position double not null, x_position double not null, width double not null, height double not null, foreground_red integer default 255 not null, foreground_blue integer default 255 not null, foreground_green integer default 255 not null, line_width double default 1.0 not null, line_style integer default 1 not null, no_border bit default 'true' not null, no_fill bit default 'true' not null, shape_defn longvarchar, constraint pk_Label primary key (id));
