...
create table LinkTerminusProperty (id integer generated by default as identity (start with 1), property_id integer not null, name varchar(128) not null, constraint pk_LinkTerminusProperty primary key (link_terminus_id, property_id), constraint Alter_Key34 unique (link_terminus_id, property_id), constraint Alter_Key33 unique (link_terminus_id, name), unique (name));
