...
alter table CompoundChildNode add constraint Relationship8 foreign key (parent_node_id) references CompoundNode;
alter table CompoundRootNode add constraint FKCompoundRo201858 foreign key (referring_model_id) references Model;
alter table Folder add constraint Relationship10 foreign key (repository_id) references Repository;
