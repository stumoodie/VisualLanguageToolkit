...
create table CompoundGraph (id integer generated by default as identity (start with 1), canvas_id integer not null, root_node_id integer not null, constraint pk_Model primary key (id), constraint xak1model unique (canvas_id));
create table BendPoint (id integer generated by default as identity (start with 1), index_pos integer not null, x_position integer not null, y_position integer not null, LinkAttributeid integer, constraint pk_BendPoint primary key (id), constraint Alter_Key37 unique (index_pos));
...
create table CanvasAttributeProperty (property_id integer not null, name varchar(128) not null, canvas_attribute_id integer not null, constraint pk_ShapeProperty primary key (property_id), constraint xax1canvasattributeproperty unique (property_id, name));
...
create table LinkTerminus (id integer generated by default as identity (start with 1), link_term_type smallint not null, offset_val smallint not null, LinkAttributeid integer, constraint pk_LinkTerminus primary key (id), constraint xak1LinkTerminus unique (link_term_type));
...
create table LabelAttribute (id integer generated by default as identity (start with 1), displayed_property_id integer not null, is_displayed bit not null, background_red integer not null, background_green integer not null, background_blue integer not null, no_fill_set bit not null, x_position integer not null, y_position integer not null, width integer not null, height integer not null, constraint pk_Label primary key (id), constraint xak1labelattribute unique (displayed_property_id));
create table LinkAttribute (id integer not null, object_type_id integer not null, name varchar(128) not null, detailed_description longvarchar not null, description varchar(2048) not null, line_red integer not null, line_green integer not null, line_blue integer not null, line_style integer not null, line_width integer not null, router_type smallint not null, url varchar(2048) not null, constraint pk_Link primary key (id));
create table ShapeAttribute (id integer not null, name varchar(128) not null, object_type_id integer not null, description varchar(2048) not null, detailed_description longvarchar not null, fill_red integer not null, fill_green integer not null, fill_blue integer not null, line_red integer not null, line_green integer not null, line_blue integer not null, line_style integer not null, line_width integer not null, padding integer not null, shape_type smallint not null, x_position integer not null, y_position integer not null, height integer not null, width integer not null, url varchar(2048) not null, constraint pk_Shape primary key (id));
...
create table MapDiagram (id integer generated by default as identity (start with 1), repository_id integer not null, inode integer not null, folder_id integer not null, name varchar(128) not null, description varchar(2048) not null, constraint pk_MapDiagram primary key (id), constraint xak2mapdiagram unique (repository_id, inode), constraint xak1mapdiagram unique (folder_id, name));
create table Folder (id integer generated by default as identity (start with 1), inode integer not null, repository_id integer not null, constraint pk_Folder primary key (id), constraint xak1folder unique (repository_id, inode));
...
create table CanvasPropertyAttribute (id integer not null, canvas_id integer not null, creation_serial integer not null, primary key (id), constraint xak1canvasattribute unique (canvas_id, creation_serial));
create table ChildCompoundGraph (id integer not null, root_node_id integer not null, constraint xpk1childmodel primary key (id), constraint xak1childmodel unique (root_node_id));
...
alter table BendPoint add constraint Relationship79 foreign key (LinkAttributeid) references LinkAttribute;
...
alter table CanvasAttributeProperty add constraint Relationship74 foreign key (property_id) references Property;
...
alter table LabelNode add constraint Relationship143 foreign key (id) references CompoundNode;
alter table LinkTerminus add constraint FKLinkTermin403161 foreign key (LinkAttributeid) references LinkAttribute;
...
alter table CanvasPropertyAttribute add constraint Relationship147 foreign key (canvas_id) references Canvas;
alter table LinkAttribute add constraint Relationship140 foreign key (id) references CanvasPropertyAttribute;
alter table ShapeAttribute add constraint Relationship141 foreign key (id) references CanvasPropertyAttribute;
alter table CanvasAttributeProperty add constraint Relationship146 foreign key (canvas_attribute_id) references CanvasPropertyAttribute;
...
alter table ChildCompoundGraph add constraint FKChildCompo443436 foreign key (root_node_id) references CompoundNode;
