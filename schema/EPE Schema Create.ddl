...
create table LinkAttribute (id integer not null, last_bendpoint_serial integer not null, object_type_id integer not null, line_red integer not null, line_green integer not null, line_blue integer not null, line_style integer not null, line_width integer not null, constraint pk_Link primary key (id));
create table ShapeAttribute (id integer not null, object_type_id integer not null, fill_red integer not null, fill_green integer not null, fill_blue integer not null, line_red integer not null, line_green integer not null, line_blue integer not null, line_style integer not null, line_width integer not null, shape_defn varchar(4096) not null, x_position double not null, y_position double not null, height double not null, width double not null, constraint pkShapeAttribute primary key (id));
