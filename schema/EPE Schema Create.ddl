...
create table LabelAttribute (id integer not null, property_id integer, background_red integer not null, background_green integer not null, background_blue integer not null, y_position double not null, x_position double not null, width double not null, height double not null, constraint pk_Label primary key (id));
