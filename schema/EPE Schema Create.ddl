...
create table Property (id integer generated by default as identity (start with 1), canvas_attribute_id integer not null, displayed_label_id integer, name varchar(255) not null, display_name varchar(1024) default '"A Display"' not null, uri varchar(4096) not null, constraint pk_Property primary key (id));
