...
create table LabelAttribute (id integer generated by default as identity (start with 1), canvas_id integer not null, creation_serial integer not null, displayed_property_id integer not null, is_displayed bit not null, background_red integer not null, background_green integer not null, background_blue integer not null, no_fill_set bit not null, x_position integer not null, y_position integer not null, width integer not null, height integer not null, constraint pk_Label primary key (id), constraint xak1labelattribute unique (displayed_property_id));
