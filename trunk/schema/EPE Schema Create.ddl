...
create table Repository (id integer generated by default as identity (start with 1), name varchar(128) not null, description varchar(2048) not null, build_num integer not null, last_inode integer not null, constraint pk_Repository primary key (id), constraint Alter_Key1 unique (name));
