...
create table SubFolder (id integer not null, parent_folder_id integer not null, description varchar (2048) not null,name varchar(128) not null, constraint pk_SubFolder primary key (id), constraint xak1subfolder unique (parent_folder_id, name));
