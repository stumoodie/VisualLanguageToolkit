...
create table ObjectType (id integer generated by default as identity (start with 1), context_id integer not null, unique_id integer not null, display_name varchar(128) not null, description varchar(2048) not null, constraint pk_ObjectType primary key (id), constraint xak2ObjectType unique (context_id, unique_id), constraint xak1objecttype unique (context_id, display_name));
