...
public class HibContext implements Serializable {
	...
	public HibContext(String globalId, String name, int majorVersion,
			int minorVersion, int patchVersion, String description) {
	...
	public HibContext(String globalId, String name, int majorVersion,
			int minorVersion, int patchVersion, String description,
			Set<HibObjectType> hibObjectTypes) {
		this.globalId = globalId;
		this.name = name;
		this.majorVersion = majorVersion;
		this.minorVersion = minorVersion;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HibContext))
			return false;
