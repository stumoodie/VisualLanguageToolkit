 ...
 *
 */
public class ShapeModel extends ArchetypalChildCompoundGraph implements IShapeModel {
	private final ShapeFactory shapeFactory;
	private final ChildModelLinkFactory childLinkFactory;
	
	public ShapeModel(CommonCanvasObject root){
	...
	@Override
	public CommonCanvasObject getRootNode(){
		return (CommonCanvasObject)super.getRootNode();
	}
}
