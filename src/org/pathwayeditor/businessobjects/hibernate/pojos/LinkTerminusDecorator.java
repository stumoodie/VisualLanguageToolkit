 ...
 */
public class LinkTerminusDecorator  implements java.io.Serializable {
    ...
    public LinkTerminusDecorator() {
    }

    public LinkTerminusDecorator(LinkTerminus linkTerminus, short shapeType, int fillRed, int fillGreen, int fillBlue, int lineRed, int lineGreen, int lineBlue, int lineWidth, int lineStyle, int width, int height) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LinkTerminusDecorator) ) return false;
		 LinkTerminusDecorator castOther = ( LinkTerminusDecorator ) other; 
