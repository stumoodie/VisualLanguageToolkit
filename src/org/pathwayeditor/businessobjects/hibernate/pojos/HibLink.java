 ...
 */
public class HibLink  implements IBusinessObjectData<Link>, Serializable {
     private Long id;
 ...
 && (this.getLinkIndex()==castOther.getLinkIndex())
 ...
 && ( (this.getTargetShape()==castOther.getTargetShape()) || ( this.getTargetShape()!=null && castOther.getTargetShape()!=null && this.getTargetShape().equals(castOther.getTargetShape()) ) );
   ...
   public int hashCode() {
         ...
         result = 37 * result + this.getLinkIndex();
  ...
  // The following is extra code specified in the hbm.xml files
	...
	public Link getBusinessObject() {
		if(this.businessObject == null){
			this.businessObject = new Link(this);
		}
