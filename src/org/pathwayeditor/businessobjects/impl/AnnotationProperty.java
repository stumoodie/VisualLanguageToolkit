...
public abstract class AnnotationProperty implements IAnnotationProperty {
	...
	protected AnnotationProperty(AnnotatedCanvasAttribute owner, IPropertyDefinition propDefn) {
		this.owner = owner;
		this.propDefn = propDefn;
	}

	protected AnnotationProperty(AnnotatedCanvasAttribute newOwner, AnnotationProperty other) {
		this.owner = newOwner;
	...
	private void createNewLabel() {
		if(this.labelAttribute == null){
			ILabelNodeFactory fact = this.owner.getCurrentDrawingElement().getSubModel().labelNodeFactory();
			fact.setProperty(this);
			ILabelNode newLabelNode = fact.createLabel();
			this.labelAttribute = newLabelNode.getAttribute();
		}
		else {
			this.labelAttribute.getCurrentDrawingElement().markRemoved(false);
		}
	}
	
	private void removeLabel() {
		this.labelAttribute.getCurrentDrawingElement().markRemoved(true);
...
//		model.removeSubgraph(fact.createGeneralSelection());
	...
	@Override
	public AnnotatedCanvasAttribute getOwner() {
		return this.owner;
	}
